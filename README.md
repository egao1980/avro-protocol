...
`schema-protocol-avro` implements [`schema-protocol`](https://github.com/egao1980/schema-protocol) `avro-schema` (`defschema` → Avro JSON schema tree).

OCI **0.1.0** — `ghcr.io/egao1980/cl-systems/avro-protocol:0.1.0` · `schema-protocol-avro:0.1.0`
...
(schema-protocol:avro-schema 'user)   ; after defschema user
```
